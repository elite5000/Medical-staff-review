...
void main() {
  ...
  testWidgets('creates a practice from scratch and generates a roster satisfying its rules', (
    tester,
  ) async {
    ...
    await tester.pumpAndSettle();
    await tester.enterText(find.widgetWithText(TextField, 'Name'), buildingName);
    ...
    await tester.tap(find.byType(DropdownButtonFormField<int>).first); // Building
    await tester.pumpAndSettle();
    ...
    await tester.pumpAndSettle();
    await tester.enterText(find.widgetWithText(TextField, 'Minimum count'), '1');
    await tester.tap(find.widgetWithText(FilledButton, 'Save'));
    await tester.pumpAndSettle();
    ...
    await tester.pumpAndSettle();
    await tester.enterText(find.widgetWithText(TextField, 'Number of days'), '1');
